...
async function stageTest() {
    ...
    let result = await hs.testPage(page,
        ...
        () => {
            ...
            if (links.length < 5) return hs.wrong(errorMsg);
            ...
            if (!isGoogleFontLinked) return hs.wrong(errorMsg);
            ...
            if (!isCssLinked) return hs.wrong(errorMsg);
            ...
            if (!bodyStyle || bodyStyle.includes(regular) || bodyStyle.trim().length < 1) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!about) return hs.wrong(errorMsg);
            ...
            if (missingAboutClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!imgWrapper) return hs.wrong(errorMsg);
            ...
            if (missingImgWrapperClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (missingImgClass) return hs.wrong(errorMsg);
            ...
            if (!textWrapperDiv) return hs.wrong(errorMsg);
            ...
            if (missingTextWrapperDivClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!h2) return hs.wrong(errorMsg);
            ...
            if (missingH2Classes.length > 0) return hs.wrong(errorMsg);
            ...
            if (!h2.innerText.includes(h2Content)) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!products) return hs.wrong(errorMsg);
            ...
            if (missingProductsClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!wrapperDiv) return hs.wrong(errorMsg);
            ...
            if (!wrapperDiv.className.includes(wrapperClass)) return hs.wrong(errorMsg);
            ...
            if (colDivs.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < colDivs.length; i++) {
                ...
                if (div !== divNodeName) return hs.wrong(errorMsg);
            }
            ...
            if (missingColClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (cardDivs.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < cardDivs.length; i++) {
                ...
                if (!parent.includes(parentClass)) return hs.wrong(errorMsg);
            }
            ...
            if (missingCardClass.length > 0) return hs.wrong(errorMsg);
            ...
            if (cardImgs.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < cardImgs.length; i++) {
                ...
                if (img !== imgNodeName) return hs.wrong(errorMsg);
            }
            ...
            if (cardBodyDivs.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            if (cardTitles.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < cardTitles.length; i++) {
                ...
                const h5NodeName = "H5";
                if (h5 !== h5NodeName) return hs.wrong(errorMsg);
            }
            ...
            for (let i = 0; i < cardTitles.length; i++) {
                ...
                if (parent !== parentClass) return hs.wrong(errorMsg);
            }
            ...
            for (let i = 0; i < cardTitles.length; i++) {
                ...
                if (innerText.trim().length <= 1) return hs.wrong(errorMsg);
            }
            ...
            if (cardTexts.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < cardTexts.length; i++) {
                ...
                const pNodeName = "P";
                if (p !== pNodeName) return hs.wrong(errorMsg);
            }
        ...
        () => {
            ...
            if (!isScriptLinked) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!reviews) return hs.wrong(errorMsg);
            ...
            if (missingReviewsClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!toggleContainerDiv) return hs.wrong(errorMsg);
            ...
            if (missingToggleContainerClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!toggleButton) return hs.wrong(errorMsg);
            ...
            if (missingToggleClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!toggleButtonType || !toggleButtonType.includes(typeValue)) return hs.wrong(errorMsg);
            ...
            if (!toggleButton.innerText.includes(toggleButtonText)) return hs.wrong(errorMsg);
            ...
            if (!dataBsToggle || !dataBsToggle.includes(dataBsToggleValue)) return hs.wrong(errorMsg);
            ...
            if (!dataBsTarget || !dataBsTarget.includes(dataBsTargetValue)) return hs.wrong(errorMsg);
            ...
            if (!ariaExpanded || !ariaExpanded.includes(ariaExpandedValue)) return hs.wrong(errorMsg);
            ...
            if (!ariaControls || !ariaControls.includes(ariaControlsValue)) return hs.wrong(errorMsg);
            ...
            if (!collapse) return hs.wrong(errorMsg);
            ...
            if (collapseDiv !== divNodeName) return hs.wrong(errorMsg);
            ...
            if (!collapse.className.includes(collapseClass)) return hs.wrong(errorMsg);
            ...
            if (!cardContainer) return hs.wrong(errorMsg);
            ...
            if (!cardContainer.className.includes(cardContainerClass)) return hs.wrong(errorMsg);
            ...
            if (!formCardDiv) return hs.wrong(errorMsg);
            ...
            if (missingFormClasses.length > 0) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < colDivs.length - 1; i++) {
                ...
                if (!colClass.includes(colDivsClass)) return hs.wrong(errorMsg);
            }
            ...
            if (!lastCol.className.includes(col12)) return hs.wrong(errorMsg);
            ...
            if (labels.length !== labelAmount) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < labels.length; i++) {
                ...
                if (!forAttr || missingFor) return hs.wrong(errorMsg);
            }
            ...
            if (inputs.length !== inputAmount) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < inputs.length; i++) {
                ...
                if (!typeAttr || !typeAttr.includes(inputType)) return hs.wrong(errorMsg);
            }
            ...
            for (let i = 0; i < inputs.length; i++) {
                ...
                if (id !== labelsForAttrs[i]) return hs.wrong(errorMsg);
            }
            ...
            if (!submitButton) return hs.wrong(errorMsg);
            ...
            if (!submitButtonId || !submitButtonId.includes(correctSubmitId)) return hs.wrong(errorMsg);
            ...
            if (!submitButtonType || !submitButtonType.includes(submitType)) return hs.wrong(errorMsg);
            ...
            if (missingSubmitClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (submitButtonText.trim().length <= 1) return hs.wrong(errorMsg);
            ...
            if (!submitParent.includes(submitParentClass)) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!rowId || !rowId.includes(correctRowId)) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < cardTitles.length; i++) {
                ...
                const h4NodeName = "H4";
                if (h4 !== h4NodeName) return hs.wrong(errorMsg);
            }
            ...
            if (blockquotes.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            if (missingBlockquoteClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (blockquoteTexts.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            if (blockquoteFooters.length !== totalAmount) return hs.wrong(errorMsg);
            ...
            if (missingBlockquoteFooterClasses.length > 0) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < blockquoteFooters.length; i++) {
                ...
                if (!innerTag) return hs.wrong(errorMsg);

                const italicNode = innerTag.nodeName;
                const italic = "I";
                if (italicNode !== italic) return hs.wrong(errorMsg);
            }
        ...
        () => {
            ...
            if (!newReviewCol) return hs.wrong(newReviewHTML.outerHTML);
            ...
            if (missingNewReviewColClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!newReviewCard) return hs.wrong(errorMsg);
            ...
            if (missingNewCardClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!newReviewCardBody) return hs.wrong(errorMsg);
            ...
            if (!newReviewCardBody.className.includes(newCardBodyClass)) return hs.wrong(errorMsg);
            ...
            if (!newReviewCardTitle) return hs.wrong(errorMsg);
            ...
            if (!newReviewCardTitle.className.includes(newCardTitleClass)) return hs.wrong(errorMsg);
            ...
            if (newReviewCardTitleText.trim() !== reviewTitle.value) return hs.wrong(errorMsg);
            ...
            if (!newReviewBlockquote) return hs.wrong(errorMsg);
            ...
            if (missingNewBlockquoteClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!newReviewBlockquoteText) return hs.wrong(errorMsg);
            ...
            if (newReviewBlockquoteTextInnerText.trim() !== reviewText.value) return hs.wrong(errorMsg);
            ...
            if (!newReviewBlockquoteFooter) return hs.wrong(errorMsg);
            ...
            if (missingNewBlockquoteFooterClasses.length > 0) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!newReviewFooter.includes(anon)) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!titleReq) return hs.wrong(errorMsg);
            ...
            if (!textReq) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!contact) return hs.wrong(errorMsg);
            ...
            if (missingContactClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!textContainer) return hs.wrong(errorMsg);
            ...
            if (missingTextContainerClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!infoContainer) return hs.wrong(errorMsg);
            ...
            if (missingInfoContainerClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (pTags.length !== pTotal) return hs.wrong(errorMsg);
            ...
            for (let i = 0; i < pTags.length; i++) {
                ...
                if (!pClass.includes(fs5)) return hs.wrong(errorMsg);
            }
            ...
            for (let i = 0; i < pTags.length; i++) {
                ...
                if (pClass.trim().length <= 1) return hs.wrong(errorMsg);
            }
            ...
            if (!addressB || addressB.innerText !== addressText) return hs.wrong(errorMsg);
            ...
            if (!phoneB || phoneB.innerText !== phoneText) return hs.wrong(errorMsg);
            ...
            if (!emailB || emailB.innerText !== emailText) return hs.wrong(errorMsg);
            ...
            if (!phoneA || phoneA.innerText.trim().length <= 1) return hs.wrong(errorMsg);
            ...
            if (!phoneHref || !phoneHref.includes("tel:")) return hs.wrong(errorMsg);
            ...
            if (!emailA || emailA.innerText.trim().length <= 1) return hs.wrong(errorMsg);
            ...
            if (!emailHref || !emailHref.includes("mailto")) return hs.wrong(errorMsg);
            ...
            if (!visualsContainer || nodeName !== div) return hs.wrong(errorMsg);
            ...
            if (missingVisualsContainerClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!ratioDiv) return hs.wrong(errorMsg);
            ...
            if (missingRatioDivClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!iframe) return hs.wrong(errorMsg);
            ...
            if (!iframeSrc || !iframeSrc.includes(src)) return hs.wrong(errorMsg);
            ...
            if (!iframeLoading || !iframeLoading.includes(loading)) return hs.wrong(errorMsg);
            ...
            if (!imgWrapper || wrapperNodeName !== div) return hs.wrong(errorMsg);
            ...
            if (!imgSrc || imgSrc.trim().length <= 1) return hs.wrong(errorMsg);
        ...
        () => {
            ...
            if (!footer || footer.nodeName !== footerNodeName) return hs.wrong(errorMsg);
            ...
            if (missingNavContainerClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!ul.className.includes(ulClass)) return hs.wrong(errorMsg);
            ...
            if (missingLinkClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!aContactAria || !aContactAria.includes(ariaCurr)) return hs.wrong(errorMsg);
            ...
            if (!spanContainer) return hs.wrong(errorMsg);
            ...
            if (missingSpanContainerClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!span) return hs.wrong(errorMsg);
            ...
            if (missingSpanClasses.length > 0) return hs.wrong(errorMsg);
            ...
            if (!span.innerText.trim().includes(innerText)) return hs.wrong(errorMsg);
